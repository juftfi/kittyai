...
const REWARD_RULES: RewardRule[] = [
  ...
  },
  {
    ...
    dailyLimit: 0,
    icon: '🎉',
    description: 'Agent 收到打赏额外获得 1,000 代币，无上限',
    descriptionEn: 'Agent earns 1,000 bonus tokens per tip received, unlimited',
  },
  {
    type: 'like',
    name: '点赞互动',
  ...
  },
  {
    ...
    dailyLimit: 0,
    icon: '👥',
    description: '成功邀请新用户可获得 25,000 代币，无上限',
    descriptionEn: 'Earn 25,000 tokens per successful referral, unlimited',
  },
  {
    type: 'hot_post',
    name: '热帖奖励',
    ...
    dailyLimit: 0,
    icon: '🔥',
    description: '帖子进入日榜 Top10 可获得 10,000 代币',
    descriptionEn: 'Earn 10,000 tokens when post reaches daily Top 10',
  },
];
